...
class LiveFaceRecognitionSystem:
    def __init__(self,
                 ...
                 detection_interval=2,  # Interval in seconds between detection attempts
                 min_detection_cooldown=3,  # Minimum time between consecutive detections
                 attendance_log_path="Attendance"  # Add this line
                 ):
        """
    ...
    def run_live_recognition(self, video_source=1):
        """
        Modified run_live_recognition to include attendance logging
        """
...
if __name__ == '__main__':
    ...
    recognition_system = LiveFaceRecognitionSystem(
        detection_interval=2,  # Seconds between detection attempts
        min_detection_cooldown=2,  # Minimum time between detections
        attendance_log_path='attendance_log.csv'  # Optional custom log path
    )
