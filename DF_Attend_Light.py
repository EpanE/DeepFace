...
class LightweightAttendanceSystem:
    ...
    def _load_known_faces(self):
        """Pre-load and cache face embeddings for known employees"""
    ...
    def mark_attendance(self, name):
        ...
        today_entries = self.attendance_log[
            (self.attendance_log['Name'] == name) &
    ...
    def run_attendance_system(self):
        ...
        while True:
            ...
            if self.frame_count % self.frame_skip == 0 and \
                    current_time - last_recognition_time > recognition_cooldown and \
                    len(faces) > 0:
...
def main():
    ...
    system = LightweightAttendanceSystem(database_path=database_path)
